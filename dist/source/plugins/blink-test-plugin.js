...
jsPsych.plugins['blink-test'] = function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        var element = 'When the test begins, you will see a circle light up(as seen below)' + ' <br><div id="circle" class="circle"></div><br> ' + 'We will take ' + plugin.info.parameters.samples + ' samples<br>' + 'Press Next To Start' + '<button id="blink-next" class="jspsych-btn">Next &gt;</button></div>';
        ...
        $('#blink-next').click(function (e) {
            ...
            element = '<br><div id="circle" class="circle"></div><br> ' + 'Trials Left: <p id="num-trials">' + plugin.info.parameters.samples + '</p>';
            display_element.append(element);
    ...
    * */
    ...
    function endTrial() {
        ...
        if (plugin.info.parameters.num_trials === 0) jsPsych.endExperiment("Trials over");else {
